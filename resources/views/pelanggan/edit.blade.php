        ...
        <div class="card page-header page-header-light">
            <div class="page-header-content header-elements-md-inline">
                <div class="page-title">
                    <h2><span class="font-weight-semibold mx-2">FOODCOURT</span> - Edit pelanggan baru</h2>
            ...
            <div class="card-body">
                <form action="{{ route('pelanggan.update',$pelanggan->pelanggan_id) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label>Nama:</label>
                        <input type="text" class="form-control" placeholder="Silahkan masukan nama pelanggan" name="pelangganName" value="{{ $pelanggan->nama }}">
                    </div>
                    <div class="form-group">
                        <label>Alamat:</label>
                        <input type="text" class="form-control" placeholder="Silahkan masukan nama Alamat" name="alamat" value="{{ $pelanggan->alamat }}">
                    </div>
                    <div class="form-group">
                        <label>No Telepon:</label>
                        <input type="text" class="form-control" placeholder="Silahkan masukan nomor telepon" name="noTelp" value="{{ $pelanggan->no_telp }}">
                    </div>
