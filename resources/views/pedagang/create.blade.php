		...
		<div class="card page-header page-header-light">
		    <div class="page-header-content header-elements-md-inline">
		        <div class="page-title">
		            <h2><span class="font-weight-semibold mx-2">FOODCOURT</span> - Tambah pedagang baru</h2>
			...
			<div class="card-body">
				<form action="{{ route('pedagang.store') }}" method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
						<label>Nama:</label>
						<input type="text" class="form-control" placeholder="Silahkan masukan nama pedagang" name="pedagangName">
					</div>
					<div class="form-group">
						<label>Nama Outlet:</label>
						<input type="text" class="form-control" placeholder="Silahkan masukan nama outlet" name="outletName">
					</div>
					<div class="form-group">
