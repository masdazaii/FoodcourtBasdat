...
@section('content')
    ...
    <div class="card page-header page-header-light">
        <div class="page-header-content header-elements-md-inline">
            <div class="page-title">
                <h2><span class="font-weight-semibold mx-2">FOODCOURT</span> - Pedagang</h2>
            </div>
        </div>
	...
	<div class="card">
        <div class="card-header">
        	<a class="btn btn-primary" href="{{URL::to('/pedagang/create')}}"><i class="far fa-plus-square mr-2"></i>Tambah pedagang baru</a>
        </div>
        <div class="card-body">
	...
	<script>
		$(document).ready(function() {
            ...
            $("#table").DataTable({
                ...
                "processing": true,
                "serverSide": true,
                "ajax": {'url':"{{ url('pedagangAjax') }}",
                        'headers':"{{ csrf_token() }}"},
                "order": ['0', 'desc'],
                "dataSrc": "data",
                "columns": [
                    {data: 'pedagang_id', name: 'pedagang_id'},
